<template>
  <div class="recent-post-container">
    <div @click="printArticles()" class="article-first">
    ...
    <div v-if="articleList.length" >
      ...
      >
        ...
        <div class="recent-post-item-image" :class="{ leftImage: index % 2 !== 0, rightImage: index % 2 === 0 }">
          <el-image class="my-el-image" v-once lazy fit="cover" :src="article.articleCover">
        ...
        <div class="recent-post-item-post" :class="{ leftImage: index % 2 === 0, rightImage: index % 2 !== 0 }">
          ...
          <div class="post-meta">
            ...
            发布于 {{ article.createTime | dateFormat }}
          </div>
          <!-- 标题 -->
            ...
            <span>
              <svg viewBox="0 0 1024 1024" width="14" height="14" style="vertical-align: -2px;">
                ...
                <path
                  ...
                  fill="#3D3D63"></path>
              </svg>{{ article.commentCount ? article.commentCount : 0 }} 条评论
            </span>
            <span>
              <svg viewBox="0 0 1024 1024" width="14" height="14" style="vertical-align: -2px;">
                <path
